...
imageNames = dir(fullfile('E:\code_video_watermarking1\watermarkedframes\','*.jpg'));
imageNames = {imageNames.name}';
outputVideo = VideoWriter(fullfile('E:\code_video_watermarking1\','watermarked_video.avi'));
outputVideo.FrameRate = baby.FrameRate;
open(outputVideo);
for i = 1:length(imageNames)
    img = imread(fullfile('E:\code_video_watermarking1\watermarkedframes',imageNames{i}));
   % img = ycbcr2rgb(img);
